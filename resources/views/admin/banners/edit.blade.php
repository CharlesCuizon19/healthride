...
@section('title', 'Homepage Banners / Edit Banner')
...
<div class="max-w-screen-2xl mx-auto">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 md:p-10">
        ...
        <form
            ...
            <div>
                <p class="block text-sm font-semibold text-[#071434] mb-3">
                    Current Image
                </p>
            ...
            <div class="rounded-2xl border-2 border-dashed border-gray-200 bg-[#f9fbfd] p-10 text-center
                ...
                <p class="font-bold text-[#071434] text-lg mb-1">
                    Replace Image (Optional)
                </p>

                <p class="text-sm text-gray-500 mb-6">
                    Upload a new banner image (Max 5MB • JPG • PNG • WEBP • GIF)
                </p>
                ...
                <label for="media" class="cursor-pointer inline-flex flex-col items-center">
                    ...
                    <span class="text-gray-600">
                        Click below or choose an image
                    </span>
            ...
            <div id="preview-container" class="hidden">
                <p class="font-semibold text-[#071434] mb-3">New Preview</p>
