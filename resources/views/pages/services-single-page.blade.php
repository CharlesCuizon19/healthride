...
{{-- SERVICES SINGLE SECTION (RESPONSIVE – FULL CODE) --}}
<section class="w-full bg-white pb-40 md:pb-40 pt:24 md:pt-24">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-0">

        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10">
            ...
            <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="pb-5 md:pb-7">
                        ...
                        <div class="rounded-2xl overflow-hidden bg-gray-100">
                            <img
                                ...
                                class="w-full h-[220px] sm:h-[280px] md:h-[380px] lg:h-[520px] object-cover">
                        </div>

                        {{-- Title + Body --}}
                        <div class="mt-6">
                            <h2 class="text-xl sm:text-2xl md:text-4xl font-extrabold text-[#0b1b3a] leading-tight">
                                {{ $service->title ?? 'Dialysis Transportation' }}
                            </h2>

                            <p class="mt-4 text-base sm:text-lg md:text-xl leading-relaxed text-gray-600">
                            ...
                            <a href="#"
                                class="mt-4 inline-flex items-center text-sm sm:text-base md:text-xl font-semibold text-emerald-700 hover:text-emerald-800">
                                Read More
                            ...
                            {{-- Service Featured --}}
                            <div class="mt-7">
                                <h3 class="text-sm sm:text-lg font-bold text-[#0b1b3a] uppercase tracking-wide">
                                    Service Featured
                                </h3>

                                <ul class="mt-4 space-y-3 text-base sm:text-lg text-gray-700">
                                    @foreach($features as $item)
                                    <li class="flex items-start gap-2">
                                        <span class="mt-0.5 inline-flex h-5 w-5 items-center justify-center shrink-0">
                ...
                <div class="bg-white">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button"
                                class="gallery-prev h-10 w-10 md:h-9 md:w-9 rounded-full border border-gray-200 hover:bg-gray-50 flex items-center justify-center">
                                ‹
                            </button>
                            <button type="button"
                                class="gallery-next h-10 w-10 md:h-9 md:w-9 rounded-full border border-gray-200 hover:bg-gray-50 flex items-center justify-center">
                                ›
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="swiper serviceGallery pb-10">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ $img }}"
                                    class="w-full h-[160px] sm:h-[200px] md:h-[240px] lg:h-[250px] object-cover rounded-xl"
                                    alt="Gallery image">
                            </div>
                            @endforeach
                        </div>
                ...
                {{-- Why Choose Us --}}
                <div class="bg-[#f4f5f7] rounded-2xl px-5 sm:px-8 py-8 sm:py-10 text-center border border-gray-200">
                    <h3 class="text-xl md:text-2xl font-extrabold text-[#0b1b3a]">
                        Why Choose Us?
                    </h3>

                    <p class="mt-3 text-sm sm:text-base md:text-lg text-black max-w-3xl mx-auto">
            ...
            {{-- RIGHT SIDEBAR --}}
            <aside class="lg:col-span-4 space-y-7 order-last lg:order-none">
                ...
                <div class="rounded-2xl overflow-hidden shadow-sm border border-gray-200">
                    <div class="bg-gradient-to-br from-[#0b2a5a] via-[#071b3c] to-[#00786a] text-white p-6 sm:p-8 md:p-9">

                        <div class="h-20 w-20 rounded-full bg-white/10 flex items-center justify-center mb-6">
                            <img
                                src="{{ asset('images/phone_call.png') }}"
                                alt="Phone Icon"
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="text-3xl md:text-4xl font-extrabold tracking-wide pb-2">
                                (925) 501-4813
                            </div>
